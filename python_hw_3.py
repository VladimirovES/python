...
if currency_convertor:
    ...
    target_currency_amount = int(input()) # число бабок
    target_currency = input() #eur. uah, chf, rub, byn
...
elif target_currency == 'usd': # посчитает для рубля
    currency_result = target_currency_amount * usd_rub_rate
    print(target_currency_amount, target_currency, '=', currency_result, rub_item)
else:
